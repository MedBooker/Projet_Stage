...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const fakeUser = email === 'patient@example.com' && password === 'password123';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-100 dark:from-emerald-950 dark:to-gray-900 px-4">
      <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-xl w-full max-w-md border border-emerald-100 dark:border-emerald-900/50">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              ...
              <a 
                ...
                className="text-sm text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 hover:underline"
              >
                Mot de passe oublié ?
              </a>
            </div>
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-emerald-500 dark:text-gray-500 dark:hover:text-emerald-400"
          ...
          <Button 
            type="submit" 
            className="w-full mt-2 bg-emerald-600 hover:bg-emerald-700 text-white py-3 px-4 rounded-lg transition-all duration-300 transform hover:scale-[1.01] shadow-md hover:shadow-emerald-200 dark:hover:shadow-emerald-900/50"
            disabled={isLoading}
          >
            {isLoading ? (
