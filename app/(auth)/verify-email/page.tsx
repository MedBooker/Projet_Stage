            ...
            <div className="space-y-4">
              <div className="mx-auto flex items-center justify-center h-24 w-24">
                <div className="relative">
                  ...
                  <svg className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-14 w-14 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/login" className="inline-block w-full py-3 px-6 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium rounded-lg shadow-md hover:from-emerald-600 hover:to-teal-700 transition-all">
                Se connecter
              </Link>
            </div>
          )}
            ...
            <div className="space-y-4">
              <div className="mx-auto flex items-center justify-center h-24 w-24">
                <div className="relative">
                  ...
                  <svg className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-14 w-14 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                  </svg>
                </div>
              </div>
              <h2 className="text-2xl font-bold text-gray-800">{message}</h2>
              <p className="text-gray-600">Veuillez réessayer ou contacter le support si le problème persiste.</p>
              <div className="flex space-x-4">
                <Link href="/register" className="flex-1 py-3 px-6 bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium rounded-lg text-center">Refaire la demande</Link>
                <Link href="/contact" className="flex-1 py-3 px-6 bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-medium rounded-lg shadow-md">Contact</Link>
              </div>
            </div>
          )}
        </div>
